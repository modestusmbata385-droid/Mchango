/* =========================================================
   MCHANGO — pdf.js
   Builds a PDF report from current Store data using jsPDF
   (window.jspdf, loaded via CDN script tag in index.html).
   ========================================================= */
...
function generatePDFReport(){
  ...
  const gharama = Store.listGharama();
  const mkeka = Store.mkeka();
